...
import {useEffect, useStare} from 'react';
import { ScrollView, TextInput } from "react-native-gesture-handler";
const ListUser = ({navigation}) => {
    const [data,  setData] = React.useState([]);
    const [openDialog, setOpenDialog]=useStare(false);
    const [selectedUser, setSelectedUser]=useStare(undefined);
...
const UpdateModel = props=>{
    const [name, setName]=useStare(undefined);
